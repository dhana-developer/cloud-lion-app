...
const Details = () => {
  const { address, setAddress, next, prev } = useContext(MultiStepEditFormContext);
        ...
        return (
          <div className={"details__wrapper"}>
            <div className={`form__item ${errors.q1 && "input__error"}`}>
			  ...
			  <input type="text" defaultValue={q1} name="q1" className="ant-input css-dev-only-do-not-override-apn68 ant-input-outlined"  />
              {/* <p className={"error__feedback"}>{errors.q1}</p> */}
            </div>
			<div className={`form__item ${errors.q2 && "input__error"}`}>
              <label>From When ?</label>
              {/* <Input name={"q2"} /> */}
			  <input type="text" defaultValue={q2} name="q2" className="ant-input css-dev-only-do-not-override-apn68 ant-input-outlined"  />
           
			  {/* <p className={"error__feedback"}>{errors.q2}</p> */}
            </div>
            <div className={`form__item ${errors.q3 && "input__error"}`}>
              <label>Is it on finance ?</label>
			  <input type="text" defaultValue={q3} name="q3" className="ant-input css-dev-only-do-not-override-apn68 ant-input-outlined"  />
			...
			<div className={`form__item ${errors.q4 && "input__error"}`}>
			  ...
			  <input type="text" defaultValue={q4} name="q4" className="ant-input css-dev-only-do-not-override-apn68 ant-input-outlined"  />
			...
			<div className={`form__item ${errors.q5 && "input__error"}`}>
			  ...
			  <input type="text" defaultValue={q5} name="q5" className="ant-input css-dev-only-do-not-override-apn68 ant-input-outlined"  />
